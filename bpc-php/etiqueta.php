    ...
    <body>
       ...
       <nav class="navbar navbar-personalizado">
          <div class="container">
            ...
            <form class="navbar-form navbar-right" role="form" action="control.php?pagina=registro" method="post">
      ...
      <!-- Seccion de libros-->
       <section class="container">
         <div class="row">
           ...
           <?php 
		   $consulta = "SELECT count(*) as megusta, libro.* FROM libro, gusta, etiqueta, reletiquetalibro ".
		   "WHERE libro.idLibro = gusta.idLibro and reletiquetalibro.idLibro = libro.idLibro and ".
		   "reletiquetalibro.idEtiqueta = etiqueta.idEtiqueta and etiqueta.nombre = '".$_REQUEST["nombre"]."' GROUP BY libro.idLibro";
		 $resultadoLibro = mysql_query($consulta);
		  
		   $resultado = mysql_num_rows($resultadoLibro);
		   $conta = 0;
