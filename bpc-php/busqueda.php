      ...
      <!-- Seccion de libros-->
       <section class="container">
         <div class="row">
           ...
           <?php 
		   $consulta = "SELECT count(*) as megusta, libro.* FROM libro, gusta ".
		   "WHERE libro.idLibro = gusta.idLibro and libro.nombre like '%".$_POST["buscar"]."%'  or libro.autor like '%".$_POST["buscar"]."%' GROUP BY libro.idLibro;";
