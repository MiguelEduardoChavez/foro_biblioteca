       ...
       <nav class="navbar navbar-personalizado">
          <div class="container">
            ...
            <div class="col-sm-3 col-md-3">
              <form class="navbar-form" role="form" action="busqueda.php" method="post">
                <div class="input-group">
                <input type="text" class="form-control" placeholder="Buscar: Titulo, Autor" name="buscar">
            ...
            <form class="navbar-form navbar-right" role="form" action="control.php?pagina=inicio" method="post">
                <div class="form-group">
                 <input type="text" placeholder="Usuario" class="form-control form-control-personalizado" id="correo" name="correo">
                </div>
                <div class="form-group">
                  <input type="password" placeholder="Contraseña" class="form-control form-control-personalizado" id="contrasenia" name="contrasenia">
                </div>
                <button type="submit" class="btn btn-personalizado" >Entrar</button>
                <!--a class="btn btn-personalizado"  href="inicio.html">Entrar</a-->
              </form>
      ...
      <!-- Seccion de libros-->
       <section class="container">
         <div class="row">
           ...
           <?php 
		   $consulta = "SELECT libro.* FROM libro ";
		 ...
		 while($row = mysql_fetch_array($resultadoLibro))
		{
			 ...
			 $consultaGusta = "SELECT count(*) as megusta, libro.* FROM libro, gusta WHERE  gusta.idLibro = libro.idLibro and libro.idLibro = ".$row["idLibro"];
           ...
           <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 app-grupo">
             <div class="col-xs-12 col-sm-6 col-md-6 app-figura">
               <a href="lectura.php?idLibro=<?php echo $row["idLibro"] ?>">
             ...
             <div class="hidden-xs col-sm-6 col-md-6 app-grupo-et">
               ...
               <p><span class="app-label"><strong>Puntos:</strong></span><?php echo $rowGusta["megusta"] ?></p>
               ...
               <div class="modal-content">
                 ...
                 <div class="modal-footer">
                  <div class="btn-group btn-group-center" role="group" aria-label="group button">
                    ...
                    <form method="post" action="lectura.php?idLibro=<?php echo $row["idLibro"]; ?>">
			...
			while($row = mysql_fetch_array($resultadoEtiqueta))
		{
		 ?>
              ...
              <a href="etiqueta.php?nombre=<?php echo $row["nombre"] ?>" class="list-group-item hover-list-group"><?php echo $row["nombre"] ?></a>
